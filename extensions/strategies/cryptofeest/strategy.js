...
module.exports = function container (get, set, clear) {
  return {
    ...
    getOptions: function () {
      ...
      this.option('min_periods', 'min. number of history periods', Number, 25)
      this.option('trend_ema', 'number of periods for trend EMA', Number, 5)
      this.option('neutral_rate', 'avoid trades if abs(trend_ema) under this float (0 to disable, "auto" for a variable filter)', Number, 0)
      this.option('oversold_rsi_periods', 'number of periods for oversold RSI', Number, 10)
      this.option('oversold_rsi', 'buy when RSI reaches this value', Number, 40)
    },
